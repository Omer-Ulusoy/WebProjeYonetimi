<%@ Page Title="" Language="C#" MasterPageFile="~/anaMasterPage.master" AutoEventWireup="true" CodeFile="AdminTarimAlaniveYuzolcumuGiris.aspx.cs" Inherits="AdminTarimAlaniveYuzolcumuGiris" %>
            ...
            <div class="contain">
                ...
                <div class="contain">
                    <div class="login-form">
                        <h4>Nüfus Yüzölçümü ve Tarım Alanı Giriş</h4>
                        <asp:DropDownList ID="ddlSehir" CssClass="ddlSehir" Style="width: 33%;" runat="server"></asp:DropDownList>
                        <br />
                        <asp:DropDownList ID="ddlYil" Style="width: 33%;" CssClass="ddlYil" runat="server"></asp:DropDownList>
                        <asp:TextBox ID="txtNufusBilgisi" Style="width: 33%;" runat="server" placeholder="Nüfus Bilgisi (Kişi Sayısı olarak Girilecektir.)"></asp:TextBox>
                        <asp:TextBox ID="txtYuzolcumu" runat="server" Style="width: 33%;" placeholder="Yüz Ölçümü (km² Cinsinden girilecektir.)"></asp:TextBox>
                        <asp:TextBox ID="txtTarimAlani" runat="server" Style="width: 33%;" placeholder="Tarım Alanı (ha Cinsinden Girilecektir.)"></asp:TextBox>
                        <br />
                        <div class="button-container-top">
                            <asp:Button runat="server" Text="Geri" ID="btnGeri" CssClass="button-default" OnClick="btnGeri_Click" />
                            &nbsp;
                            <asp:Button runat="server" class="button-default" ID="BtnTarimAlaniveYuzolcumuKaydet" Text="Kaydet" OnClick="BtnTarimAlaniveYuzolcumuKaydet_Click" />
                            &nbsp;
                        <asp:Button ID="btnAdminHayvanGuncelle" CssClass="button-default" runat="server" Text="Güncelle" OnClick="btnAdminHayvanGuncelle_Click" />
                            &nbsp;
                            <asp:Button ID="btnTarimAlanıveYuzolcumuSil" CssClass="button-default" runat="server" Text="Sil" OnClick="btnTarimAlanıveYuzolcumuSil_Click" />
                        </div>
                        <div>
                            <br />
