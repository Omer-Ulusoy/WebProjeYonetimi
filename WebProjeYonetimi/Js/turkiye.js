		...
		{				
			...
			obj.click(function(){	
				...
				if(paths[arr[this.id]].value == 'notSelected')
				{
					...
					//$("#hfSehir").val(paths[arr[this.id]]);
					var seh = document.getElementById('hfSehir');
					seh.value = arr[this.id];

					
					
					var abc = document.getElementById('ContentPlaceHolder2_ddlSehir');
					abc.selectedIndex = paths[arr[this.id]].county;
					document.getElementById('ContentPlaceHolder2_lblSehir').innerHTML = paths[arr[this.id]].county;
